...
/* Belonged to nused code, used to love it :( now it is just ugly
#define VAL_KEY_1		0x4
#define VAL_KEY_2		0x2
#define VAL_KEY_3 		0x80
#define VAL_KEY_4		0x8
#define VAL_KEY_5		0x1
#define VAL_KEY_ALT		0x40
#define VAL_KEY_ESC		0x10
#define VAL_KEY_OK		0x20
#define VAL_KEY_UP		0x800
#define VAL_KEY_DOWN	0x400
#define VAL_KEY_LEFT	0x100
#define VAL_KEY_RIGHT	0x200
#define VAL_KEY_POWER	0x1000
#define VAL_KEY_MENU	0x30
*/
