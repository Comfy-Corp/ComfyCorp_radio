...
extern void X12RtcfullResetClock(void);
...
/* Own FUNctions*/
extern void X12FillStringWithTime(char *stringToFillWithTime);
extern int X12GetTimeZoneString(char *timeZoneString, int tempTimezoneHour);
